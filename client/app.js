		...
		switch (_p2.ctor) {
			...
			case 'GetUpdate':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$websocket$WebSocket$send, 'ws://localhost:9292', 'fetch update')
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$State$initialModel = {
	...
	rules: {
		ctor: '::',
		_0: {
			ruleCard: {state: _user$project$Types$Saved, text: 'Some Rule'},
			examples: {ctor: '[]'}
		},
		_1: {ctor: '[]'}
	},
			...
			A2(_elm_lang$core$List$map, _user$project$View$example, es),
			{
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('card card--add'),
							_1: {ctor: '[]'}
						}
					},
					{
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(r.ruleCard.text),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Example Mapper'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('card card--story'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.storyCard.text),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
