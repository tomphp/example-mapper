...
var _user$project$Card_Types$Card = F5(
	function (a, b, c, d, e) {
		return {id: a, state: b, text: c, position: d, version: e};
	});
var _user$project$Card_Types$CardId = F2(
	function (a, b) {
		return {uid: a, cardType: b};
	});
...
var _user$project$Card_Types$UpdateCardText = function (a) {
	return {ctor: 'UpdateCardText', _0: a};
};

var _user$project$Card_State$cardId = function (cardType) {
	var _p0 = cardType;
	switch (_p0.ctor) {
		case 'RuleCard':
			return 'new-rule';
		case 'ExampleCard':
			return A2(_elm_lang$core$Basics_ops['++'], 'new-example-', _p0._0);
		case 'QuestionCard':
			return 'new-question';
		default:
			return 'new-story';
...
var _user$project$Card_State$addCardButton = function (cardType) {
	return {
		id: {
			uid: _user$project$Card_State$cardId(cardType),
			cardType: cardType
		},
		state: _user$project$Card_Types$AddButton,
		text: '',
		position: 999,
		version: 1
	};
};
var _user$project$Card_State$update = F2(
	function (msg, card) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UpdateCardText':
...
var _user$project$Rule_Types$UpdateCard = F2(
	function (a, b) {
...
var _user$project$Types$UpdateRule = F2(
	function (a, b) {
		return {ctor: 'UpdateRule', _0: a, _1: b};
	});
...
var _user$project$Types$SendRequest = function (a) {
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Dict$get(_p2._1),
					A2(
						_elm_lang$core$Maybe$map,
						function (_) {
							return _.delayed;
						},
						A2(modelIfClientIdMatches, _p2._0, model)))));
	});
...
var _user$project$Decoder_UpdateState$cardId = function (cardType) {
	return A2(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Card_Types$CardId)));
};
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'state',
					_user$project$Decoder_UpdateState$cardState,
					A2(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
...
var _user$project$Decoder_UpdateState$state = A3(
	...
	A2(_elm_lang$core$Json_Decode$field, 'rules', _user$project$Decoder_UpdateState$rules),
	A3(
		_elm_lang$core$Json_Decode$map2,
		F2(
			function (x, y) {
...
var _user$project$Rule_State$update = F2(
	function (msg, rule) {
		var _p0 = msg;
		return rule;
	});
...
var _user$project$State$send = function (url) {
	var _p0 = url;
	if (_p0.ctor === 'Just') {
		return _elm_lang$websocket$WebSocket$send(_p0._0);
	} else {
		...
		switch (_p5.ctor) {
			...
			case 'SendRequest':
				var cmd = A2(
					...
					A2(_user$project$Requests$toJson, model, _p5._0));
			...
			case 'UpdateModel':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$State$updateModel, _p5._0, model),
			...
			case 'UpdateCard':
				...
				return A3(
					...
					A3(
						...
						_p6.id,
						_elm_lang$core$Maybe$map(
							_user$project$Card_State$update(_p7)),
						model));
			default:
				var _p9 = _p5._0;
				var _p8 = _p5._1;
				return A3(
					...
					A3(
						...
						_p9.card.id.uid,
						_elm_lang$core$Maybe$map(
							_user$project$Rule_State$update(_p8)),
						model));
		}
	});
var _user$project$State$handleCardUpdate = F3(
	function (msg, card, model) {
		var thing = A2(
			_elm_lang$core$Maybe$map,
			_user$project$State$update,
			A2(
				_elm_lang$core$Maybe$map,
				_user$project$Types$SendRequest,
		...
		switch (_p10.ctor) {
			case 'StartEditing':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$State$focusCardInput(card.id.uid)
				};
			case 'StartCreateNew':
				return {
					ctor: '_Tuple2',
			...
			case 'FinishCreateNew':
				return A2(
					...
					function (m) {
						return A2(_elm_community$maybe_extra$Maybe_Extra$andMap, m, thing);
					}(
						_elm_lang$core$Maybe$Just(
							A2(
								_user$project$ModelUpdater$addDelayedAction,
...
var _user$project$State$initialModel = function (flags) {
	var newRuleColumn = {
		card: _user$project$Card_State$addCardButton(_user$project$Card_Types$RuleCard),
	...
	return {
		...
		rules: A2(_elm_lang$core$Dict$singleton, newRuleColumn.card.id.uid, newRuleColumn),
		questions: A2(_elm_lang$core$Dict$singleton, addQuestionButton.id.uid, addQuestionButton),
...
var _user$project$State$init = function (flags) {
	return A2(
		_user$project$State$update,
		_user$project$Types$SendRequest(_user$project$Requests$refresh),
		_user$project$State$initialModel(flags));
};

var _user$project$Card_View_AddButton$displayButton = function (b) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Card_Types$StartCreateNew),
			_1: {
				ctor: '::',
...
var _user$project$Card_View_AddButton$addButtonParams = function (card) {
	var _p0 = card.id.cardType;
	switch (_p0.ctor) {
		case 'RuleCard':
			return _elm_lang$core$Maybe$Just(
				{id: card.id.uid, cssClass: 'card--rule', label: 'Add Rule', cardType: card.id.cardType});
		case 'ExampleCard':
			return _elm_lang$core$Maybe$Just(
				{id: card.id.uid, cssClass: 'card--example', label: 'Add Example', cardType: card.id.cardType});
		case 'QuestionCard':
			return _elm_lang$core$Maybe$Just(
				{id: card.id.uid, cssClass: 'card--question', label: 'Add Question', cardType: card.id.cardType});
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Card_View_AddButton$view = function (_p1) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$html$Html$text('Error'),
		A2(
			_elm_lang$core$Maybe$map,
			_user$project$Card_View_AddButton$displayButton,
			_user$project$Card_View_AddButton$addButtonParams(_p1)));
};
var _user$project$Card_View_AddButton$AddButton = F4(
	function (a, b, c, d) {
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$x2(
								_elm_lang$core$Basics$toString(_user$project$Card_View_Background$cardWidth)),
							_1: {
								ctor: '::',
...
var _user$project$Card_View_Background$cardBackground = function () {
	var headLine = _elm_lang$core$Basics$toString(2 * _user$project$Card_View_Background$lineHeight);
	return A2(
		_elm_lang$core$List$append,
		{
			ctor: '::',
		...
		_user$project$Card_View_Background$lines);
}();
var _user$project$Card_View_Background$view = function (card) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$class('card__background'),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: _elm_lang$svg$Svg_Attributes$height(
						_elm_lang$core$Basics$toString(_user$project$Card_View_Background$cardHeight)),
					_1: {ctor: '[]'}
				}
			}
		},
		_user$project$Card_View_Background$cardBackground);
};

var _user$project$Card_View$cardInput = function (card) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$textarea,
			{
				...
				_0: _elm_lang$html$Html_Attributes$id(
					A2(_elm_lang$core$Basics_ops['++'], 'card-input-', card.id.uid)),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html_Events$on,
							'input',
							A2(_elm_lang$core$Json_Decode$map, _user$project$Card_Types$UpdateCardText, _elm_lang$html$Html_Events$targetValue)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Card_View$cardText = function (text) {
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('card__text'),
				_1: {ctor: '[]'}
			},
...
var _user$project$Card_View$cardContent = function (card) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('card__content'),
			_1: {ctor: '[]'}
		},
		function () {
			var _p0 = card.state;
			switch (_p0.ctor) {
				case 'Editing':
					return _user$project$Card_View$cardInput(card);
				case 'Preparing':
					return _user$project$Card_View$cardInput(card);
				default:
		...
		_elm_lang$core$List$concat(
			{
				...
				_1: {
					...
					_0: {
						ctor: '::',
						_0: _user$project$Card_View_Background$view(card),
						_1: {ctor: '[]'}
					},
					_1: {
						ctor: '::',
...
var _user$project$Rule_View$htmlCard = function (card) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Rule_Types$UpdateCard(card),
		_user$project$Card_View$view(card));
};
var _user$project$Rule_View$divCard = function (card) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Rule_View$htmlCard(card),
			_1: {ctor: '[]'}
		});
};
var _user$project$Rule_View$exampleCards = function (examples) {
	return A2(
		_elm_lang$core$List$map,
...
var _user$project$Rule_View$examples = function (rule) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		_user$project$Rule_View$exampleCards(
			_elm_lang$core$Dict$values(rule.examples)));
};
var _user$project$Rule_View$view = function (r) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id(
				A2(_elm_lang$core$Basics_ops['++'], 'rule-', r.card.id.uid)),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_user$project$Rule_Types$UpdateCard(r.card),
				_user$project$Card_View$view(r.card)),
			_1: {
				ctor: '::',
				_0: _user$project$Rule_View$examples(r),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$View$htmlCard = function (card) {
	return A2(
		_elm_lang$html$Html$map,
		_user$project$Types$UpdateCard(card),
		_user$project$Card_View$view(card));
};
var _user$project$View$divCard = F2(
	function (className, card) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$View$htmlCard(card),
				_1: {ctor: '[]'}
			});
	});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('questions__title'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
	...
	return A2(
		...
		A2(
			...
			function (rule) {
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Types$UpdateRule(rule),
					_user$project$Rule_View$view(rule));
			},
			A2(
				_elm_lang$core$List$sortBy,
				function (_p0) {
